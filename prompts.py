...
{{"summary":"2-3 sentence professional security analysis of actual issues","bugs":[],"security_issues":["specific issue 1","specific issue 2"],"performance_issues":[],"suggestions":["specific fix 1","specific fix 2","specific fix 3"],"improved_code":"","score":2}}"""
...
Return ONLY this JSON:
{{"summary":"2-3 sentence professional performance analysis of actual issues","bugs":[],"security_issues":[],"performance_issues":["specific issue 1","specific issue 2"],"suggestions":["specific fix 1","specific fix 2","specific fix 3"],"improved_code":"","score":5}}"""
...
- Functions defined inside try block
...
Return ONLY this JSON:
{{"summary":"2-3 sentence professional bug analysis of actual issues","bugs":["specific bug 1","specific bug 2"],"security_issues":[],"performance_issues":[],"suggestions":["specific fix 1","specific fix 2","specific fix 3"],"improved_code":"","score":4}}"""
...
- Security: SQL injection (string concat only), hardcoded secrets (literals only)
- Performance: N+1 queries (loop only), connection pooling
